...
`Main` has only one class called [`MainApp`](../src/main/java/f12b2/todoapp/MainApp.java). It is responsible for,
...
**API** : [`Ui.java`](../src/main/java/f12b2/todoapp/ui/Ui.java)
...
The `UI` component uses JavaFx UI framework. The layout of these UI parts are defined in matching `.fxml` files
 ...
 For example, the layout of the [`MainWindow`](../src/main/java/f12b2/todoapp/ui/MainWindow.java) is specified in
...
**API** : [`Logic.java`](../src/main/java/f12b2/todoapp/logic/Logic.java)
...
**API** : [`Model.java`](../src/main/java/f12b2/todoapp/model/Model.java)
...
**API** : [`Storage.java`](../src/main/java/f12b2/todoapp/storage/Storage.java)
...
Classes used by multiple components are in the `f12b2.todoappbook.commons` package.
...
2. **Non-GUI Tests** - These are tests not involving the GUI. They include,
   1. _Unit tests_ targeting the lowest level methods/classes. <br>
      e.g. `f12b2.todoapp.commons.UrlUtilTest`
   2. _Integration tests_ that are checking the integration of multiple code units
     (those code units are assumed to be working).<br>
      e.g. `f12b2.todoapp.storage.StorageManagerTest`
   3. Hybrids of unit and integration tests. These test are checking multiple code units as well as
      how the are connected together.<br>
      e.g. `f12b2.todoapp.logic.LogicManagerTest`
